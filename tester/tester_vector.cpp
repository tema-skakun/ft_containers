...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/27 17:54:42 by fdarkhaw          #+#    #+#             */
/*   Updated: 2022/12/25 22:35:46 by fdarkhaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_vector()
{
	...
	/* Swap */
	{
		...
		fs << "BEFORE SWAP\n";
		fs << "stl_swap_one contains:";
		for (std::vector<int>::iterator it = stl_swap_one.begin(); it!=stl_swap_one.end(); ++it)
			fs << ' ' << *it;
		fs << '\n';

		fs << "ft_swap_one contains:";
		for (ft::vector<int>::iterator it = ft_swap_one.begin(); it!=ft_swap_one.end(); ++it)
			fs << ' ' << *it;
		fs << '\n';

		fs << "stl_swap_two contains:";
		for (std::vector<int>::iterator it = stl_swap_two.begin(); it!=stl_swap_two.end(); ++it)
			fs << ' ' << *it;
		fs << '\n';

		fs << "ft_swap_two contains:";
		for (ft::vector<int>::iterator it = ft_swap_two.begin(); it!=ft_swap_two.end(); ++it)
			fs << ' ' << *it;
		fs << '\n';
		//SWAP//
