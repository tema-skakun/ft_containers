...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/07 17:22:36 by fdarkhaw          #+#    #+#             */
/*   Updated: 2022/12/25 23:23:09 by fdarkhaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		public :
			...
			*/
			...
			/*
			   ...
			   bst_it the binary search tree to be inpired by.
			*/
			...
			*/
			...
			/*
			   Give a reference to the value that contains
			...
			*/
			...
			/*
			   Give a pointer to the value that contain
			   the binary search tree (value on a node) at the iterator
			   position.
			...
			*/
			...
			/*
			   Post increment the iterator to the next value
			   after the value in the tree at iterator position.
			...
			*/
			...
			/*
			   decrement the iterator to the previous value
			...
			*/
			...
			/*
			   Post decrement the iterator to the previous value
			   before the value in the tree at iterator position.
