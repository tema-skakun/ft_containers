...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/07 17:12:26 by fdarkhaw          #+#    #+#             */
/*   Updated: 2022/12/25 22:02:54 by fdarkhaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class Binary_search_tree
	{
		public :
			...
			/*
			   Contruct an empty binary search tree
			*/
			...
			*/
			...
			/*
			   need a pair create like : make_pair(key, mapped_type())
			*/
			...
			*/
			...
			/*
			   Swap this elements with "x" elements
			*/
			void swap(self& x)
			{
				if (&x == this)
		...
		private :
			...
			/*
			   Give node pointer on lower key.
			*/
			...
			/*
			   Give node pointer on higher key.
			*/
			...
			/*
			   Used to re set link between node is necessary, and
			   delete node.
			*/
			...
			/*
			   used to move replacer node and re set all link between
